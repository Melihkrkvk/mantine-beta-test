  ...
  if (sideBarPos === 'right') {
    return (
      <Container size={'lg'}>
        <Grid columns={12}>
          <GridCol span={{ base: 8 }}>
            <Text tt={'uppercase'} fw={'bold'} fz={28} mb={20}>
              {title}
            </Text>
            <Image height={480} width={270} src={img} />
      ...
      <Grid columns={12}>
        ...
        <GridCol span={{ base: 8 }}>
          ...
          <Image
            ...
            width={270}
            src={
              'https://images.unsplash.com/photo-1515787366009-7cbdd2dc587b?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxzZWFyY2h8M3x8cGxhY2Vob2xkZXJ8ZW58MHx8MHx8fDA%3D&auto=format&fit=crop&w=800&q=60'
            }
          />
        </GridCol>
      </Grid>
